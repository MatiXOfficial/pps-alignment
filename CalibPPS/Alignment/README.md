...
| `x_min_fit_mode` | `cms.double` | `2.`                 | `2.`                 | `2.`                 | `2.`                 | Mode graph parameter. See   [buildModeGraph](https://github.com/MatiXOfficial/pps-alignment/blob/acbc8327e243151c015012bbbd4e1c882ee53584/CalibPPS/Alignment/plugins/PPSAlignmentHarvester.cc#L557).                                            |
| `x_max_fit_mode` | `cms.double` | `7.`                 | `7.5`                | `7.4`                | `8.`                 | Mode graph parameter. See   [buildModeGraph](https://github.com/MatiXOfficial/pps-alignment/blob/acbc8327e243151c015012bbbd4e1c882ee53584/CalibPPS/Alignment/plugins/PPSAlignmentHarvester.cc#L557).                                            |
| `y_max_fit_mode` | `cms.double` | `7.`                 | `7.5`                | `7.4`                | `8.`                 | Mode graph parameter (in 2018 the same value as x_max_fit_mode). See   [buildModeGraph](https://github.com/MatiXOfficial/pps-alignment/blob/acbc8327e243151c015012bbbd4e1c882ee53584/CalibPPS/Alignment/plugins/PPSAlignmentHarvester.cc#L557). |
